    ...
    <script type="text/javascript">
        ...
        function deleteTask(){
            ...
            $.ajax({
                ...
                '_token': "{{ csrf_token() }}"},
                success: function(){
                    document.location.href = "{{route('tasks')}}"}
                });
            }
    </script>
        ...
        <div class="col-md-12 mt-5">
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    @if (Auth::user()->role == 1)
                    <a href="/tasks/create">
                        <button class="btn btn-success btn-submit" style="margin-bottom: 20px;">Add Task</button>
                    </a>
                    @endif
                    <ul class="list-group">
                        ...
                        @endif
                            ...
                            <div class="col-md-1" style="padding-top: 6px;">
                                <button onclick="showTask({{$task->id}})" class="btn btn-danger btn-submit" style="border-radius:20px">X</button>
                            </div>
                            @endif
                        </div>
                        @endforeach
