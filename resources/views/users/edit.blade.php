            ...
            <div class="col-8 offset-2 mt-5">
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <form method="POST" action="{{ route('users.edit.update', $user->id) }}">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <strong>Email *:</strong>
                                        <input type="text" name="email" class="form-control" placeholder="Email" required value="{{ $user->email }}">
                                        @if ($errors->has('email'))
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        @foreach ($role as $key)
                                            <option value="{{ $key->id }}" {{$roleSelected[0]->id == $key->id ? 'selected' : ''}}> 
                                                {{ $key->role }}
                                            </option>
                                        @endforeach 
                                        </select>
